...
public class delete_issue extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String q="Delete From issues where issueId= '"+issueId+"';";
        //String query="select * from USER where user_id='"+s1+"' AND password='"+s2+"';";
        stmt.executeUpdate(q);
        JOptionPane.showMessageDialog(this, "ISSUE RECORD HAS BEEN Deleted");
        jTextField1.setText("");
        }
        catch (Exception x)
        {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(delete_issue.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
